...
export default function ScoreMarksSelectView ({ addNote, addAccidental, addStroke, addDecoration, refresh }) {
  return (
    <View style={styles.input.marks}>
      <View style={styles.input.marks.sections}>
        ...
        <StrokeSelectView addStroke={addStroke} addDecoration={addDecoration} refresh={refresh}/>
      </View>
    </View>
  )
}
