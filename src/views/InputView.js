      ...
      return m('div.v', { style: { width: 'min-content' } }, [
        m(ImageButton, {
          ...
          style: [
            ...
            { transform: `translate(-50%, -50%) rotate(${visible ? 0 : 180}deg)`, transition: 'transform 0.3s ease' }
          ]
        }),

        m('div.v.input-panel' + (visible ? '' : '.hidden'), { style: toCSS(dims.getInputViewStyle()) }, [
